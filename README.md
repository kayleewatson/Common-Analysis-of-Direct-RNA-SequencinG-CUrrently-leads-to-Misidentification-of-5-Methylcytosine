...
create_3mer_fraction_file.sh $FILTERED_FILE $REF $NAME
```
...
```
FRACTION_FILE = path_to_3mer_fraction_file
## output from create_3mer_fraction_file.sh script

histogram_methyl_fraction_individual.r $FRACTION_FILE
```
